...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public SwerveSubsystem(File directory) {
        ...
        swerveDrive.setChassisDiscretization(
                SwerveConstants.useChassisVelocityCorrection, SwerveConstants.chassisVelocityCorrection);
        swerveDrive.setHeadingCorrection(
                false); // Heading correction should only be used while controlling the robot via angle.
        swerveDrive.setCosineCompensator(SwerveConstants.useCosineCompensator
                && !SwerveDriveTelemetry
                        .isSimulation); // Disables cosine compensation for simulations since it causes discrepancies
        // not seen in real life.
        swerveDrive.setAngularVelocityCompensation(
                SwerveConstants.useAngularCompensationTeleop,
                SwerveConstants.useAngularCompensationAuton,
                SwerveConstants
                        .angularCompensation); // Correct for skew that gets worse as angular velocity increases. Start
    ...
    //                                                             .getYaw()))); // Not sure if this will work, more
    ...
    public Command driveToPose(Pose2d pose) {
        ...
        return AutoBuilder.pathfindToPose(
                pose, constraints, edu.wpi.first.units.Units.MetersPerSecond.of(0) // Goal end velocity in meters/sec
                );
    }
    ...
    public Command sysIdDriveMotorCommand() {
        return SwerveDriveTest.generateSysIdCommand(
                SwerveDriveTest.setDriveSysIdRoutine(new Config(), this, swerveDrive, 12, true), 3.0, 5.0, 3.0);
    }
